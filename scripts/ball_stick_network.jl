...
# #
# stimuli = Dict(
#     :noise_s => SNN.PoissonStimulus(network.pop.E, :h_s,   rate = 4000Hz, cells=:ALL, μ=4.7f0),
#     :noise_i1  => SNN.PoissonStimulus(network.pop.I1, :ge, rate = 30Hz, cells=:ALL, μ=1.f0),
#     :noise_i2  => SNN.PoissonStimulus(network.pop.I2, :ge, rate = 30Hz, cells=:ALL, μ=1.f0),
# )
