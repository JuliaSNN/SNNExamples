...
Threads.@threads for n in eachindex(τs)
    ...
    E1 = Identity(N=200)
    E2 = Identity(N=200)
    signal1= SNN.PoissonStimulus(E1, :g, cells = :ALL, N_pre=100, param = deepcopy(stim), name="ExtSignal_E1")
    signal2= SNN.PoissonStimulus(E2, :g, cells = :ALL, N_pre=100, param = deepcopy(stim), name="ExtSignal_E1")
