...
plot!(NSSTs, W[2,:], label= "Lateral", lw=3, title="Average EE weight", xlabel="% NSST", ylabel="Weight")
p2 =plot!(p2, NSSTs, W[3,:], label="Recurrent", lw=3)
plot!(NSSTs, W[4,:], label= "Lateral", lw=3, title="Average SST weight", xlabel="% NSSTs", ylabel="Weight")
