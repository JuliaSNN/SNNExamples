...
p1 = plot()
p1 = SNN.vecplot!(p1, model.pop.E1, :g, sym_id=1, neurons=1:10, interval=0s:4s, pop_average=true, factor=syn[1])
p1 = SNN.vecplot!(p1, model.pop.E1, :g, sym_id=2, neurons=1:20, interval=0s:4s, pop_average=true, factor=syn[2])
p1 = SNN.vecplot!(p1, model.pop.E1, :g, sym_id=3, neurons=1:20, interval=0s:4s, pop_average=true, factor=syn[3])
p1 = SNN.vecplot!(p1, model.pop.E1, :g, sym_id=4, neurons=1:20, interval=0s:4s, pop_average=true, factor=syn[4])
plot!(p1, ylims=:auto)
