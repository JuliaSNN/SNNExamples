...
p = plot()
SNN.vecplot!(p, EE, :x, r=4s:10s,dt=0.125, pop_average=true, ribbon=false, c=:red, label="", ylims=(0,1))
SNN.vecplot!(p, EE, :u, r=4s:10s, dt=0.125, pop_average=true,ribbon=false, c=:blue, label="" , )
plot!(p, ylims=(0,1))
q = SNN.vecplot(post, :v, r=4s:10s, dt=0.125, pop_average=true,ribbon=false, c=:blue, label="" )
