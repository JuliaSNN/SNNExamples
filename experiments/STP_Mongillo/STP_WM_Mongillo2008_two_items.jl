...
simtime = SNN.train!(model=model,duration=3.0s, dt=0.125, pbar=true)
for x in 1:20
    model.stim.E.I_base.=.08pA
    simtime = SNN.train!(model=model,duration=0.1s, dt=0.125, pbar=true, time=simtime)
    model.stim.E.I_base.=.0pA
    simtime = SNN.train!(model=model,duration=0.15, dt=0.125, pbar=true, time=simtime)
end

# simtime = SNN.train!(model=model,duration=3.8s, dt=0.125, pbar=true)
